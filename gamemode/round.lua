...
FlagsCFG = {
	model_white = "models/capturepoint/white_none/base.mdl",
	model = {
		Republic = "models/capturepoint/blue/republic/republic_b.mdl",
		CIS = "models/capturepoint/red/cis/cis_r.mdl",
		NONE = "models/capturepoint/white_none/base.mdl"
	},
	white_skin = 7,
	skin = {
		Republic = 0,
