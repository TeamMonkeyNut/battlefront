...
function GetTeamID( teamName )
	if teamName == "CIS" then
		return TEAM_RU
	elseif teamName == "Republic" then
		return TEAM_US
...
function WeaponTeamName( team, both )
	if team == "C" then return "CIS" end
	if team == "R" then return "Republic" end
	if team == "N" then return both end
end

function VehicleTeamName( team )
	if team == "C" then return TEAM_RU end
	if team == "R" then return TEAM_US end
...
function GetMapPointPosition( point, team )
	team = team == TEAM_US and "Republic" or team == TEAM_RU and "CIS"
